...
public class RestoranKuV3 {
    ...
    static int totalResTempat;
    static int totalResMeja;
...
//        System.out.println("---------------------------------------"); 
    ...
    static void pesanMakan(){
        ...
        System.out.println(infoDiskon(0, bayarMakan));
    ...
    static void reservasiTempat(){
        ...
        System.out.println(infoDiskon(tanggal,bayarResTempat));
    ...
    static String infoDiskon(int tanggal, int uang) {
        String info;
        if (tanggal == 2 || tanggal == 10 || tanggal == 13) {
            info = (uang > 200000 && uang <= 400000) ? "| Selamat anda mendapat diskon 3%" :
                   (uang > 400000 && uang <= 600000) ? "| Selamat anda mendapat diskon 4%" :
                   (uang > 600000) ? "| Selamat anda mendapat diskon 4,2%" : "oi";
        } else {
            info = (uang > 200000 && uang <= 400000) ? "| Selamat anda mendapat diskon 1,5%" :
                   (uang > 400000 && uang <= 600000) ? "| Selamat anda mendapat diskon 2,5%" :
                   (uang > 600000) ? "| Selamat anda mendapat diskon 2,7%" : "oi";
        }       
        return info;
    }
    ...
    static int diskon(int tanggal, int uang) {
        int diskon;
        if (tanggal == 2 || tanggal == 10 || tanggal == 13) {
            diskon = (uang > 200000 && uang <= 400000) ? 3 :
                     (uang > 400000 && uang <= 600000) ? 4 :
                     (uang > 600000) ? 42 : 0;
        } else {
            diskon = (uang > 200000 && uang <= 400000) ? 15 :
                     (uang > 400000 && uang <= 600000) ? 25 :
                     (uang > 600000) ? 27 : 0;
        }
        uang -= uang * diskon / 1000;
        return uang;
    }
